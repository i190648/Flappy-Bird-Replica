...
def score_display(game_state):
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = score_surface.get_rect(center = (150, 450))
...
pygame.mixer.pre_init(frequency = 44100, size = 16, channels = 1, buffer = 55)
pygame.init()
...
pipe_surface = pygame.transform.scale(pipe_surface, (50, 250))
pipe_list = []
SPAWNPIPE = pygame.USEREVENT
pygame.time.set_timer(SPAWNPIPE, 1200)
pipe_height = [250, 275, 300, 325, 350, 400, 450]
